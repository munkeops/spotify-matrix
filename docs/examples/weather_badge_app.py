"""Example Assistant Matrix app using the SDK."""
...
from assistant_matrix_sdk import ConfigField, MatrixCanvas, App, AppContext, AppPermission, AppPreview, AppTrigger


class WeatherBadgeApp(App):
    ...
    preview_media = AppPreview(description="Simple matrix weather badge preview.")
    permissions = [
        AppPermission("network", "Future versions may fetch live weather data."),
    ]
    ...
    triggers = [
        AppTrigger("schedule.rotation", default_enabled=True, priority=20),
    ]
...
if __name__ == "__main__":
    ...
    app.preview(
        ...
        AppContext(config={"label": "HOME", "temperature": 72, "condition": "sunny"}),
    )

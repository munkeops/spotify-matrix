"""Drawing primitives shared by the matrix games.

These live outside ``spotify_matrix`` so game modules can import them without a
circular dependency; the runtime re-exports them for its own renderers.
"""
